...
/* Subroutine */ int mylmdif_(fcn, m, n, x, fvec, ftol, xtol, gtol, maxfev, epsfcn, diag, mode, factor, nprint, info, nfev, fjac, ldfjac, ipvt, qtf, wa1, wa2, wa3, wa4)
/* Subroutine */ int (*fcn) ();
integer *m, *n;
